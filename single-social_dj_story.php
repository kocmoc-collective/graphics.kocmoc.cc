	...
	<main id="primary" class="site-main">
        ...
        <div class="site-main__inner">
            ...
            while ( have_posts() ) :
                ...
                <div class="social-dj-story-frame">

                    <div id="capture" class="social-dj-story-container">

                        <?php if ( get_field( 'radio_show_background_image' ) ) : ?>
                            <div class="social-dj-story-background-image"><img src="<?php the_field( 'radio_show_background_image' ); ?>" /></div>
                        <?php endif ?>

                        <div class="social-dj-story-container__inner">

                            <div class="social-dj-story-header">
                                <div class="social-dj-story-header__inner">
                                    <div class="station-branding">
                                        <div class="station-title">KOCMOC</div>
                                        <div class="station-subtitle">Freeform Radio Broadcasting</div>
                                    </div>
                            ...
                            <div class="social-dj-story-content">
                                <h1 class="radio-show-title"><?php the_field( 'radio_show_title' ); ?></h1>
                            </div>

                            <div class="social-dj-story-footer">
                                <div class="social-dj-story-footer__inner">
                                    <div class="radio-show-date">
                                        <span class="radio-show-day"><?php the_field( 'radio_show_date' ); ?> / </span>
                                        <span class="radio-show-time"><?php the_field( 'radio_show_start_time' ); ?> - <?php the_field( 'radio_show_end_time' ); ?> (EEST)</span>
                                    </div>
